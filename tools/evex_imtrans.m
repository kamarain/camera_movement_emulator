%EVEX_IMTRANS - homogenous transformation of an image.
%
% newim = evex_imtrans(img, T)
% newim = evex_imtrans(img, T, 'parameter', value...)
% [newim, newT] = evex_imtrans(...)
%
...
% $Id: evex_imtrans.m,v 1.9 2007/02/02 16:08:00 paalanen Exp $

function [newim, newT] = evex_imtrans(im, T, varargin);
